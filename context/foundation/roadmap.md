...
- **Prerequisites:** S-04
- **Parallel with:** —
- **Blockers:** Konto Resend (lub MailChannels) z skonfigurowanym RESEND_API_KEY w Cloudflare Pages secrets — wymagane przed wdrożeniem tego slice'a
- **Unknowns:**
...
|------------|----------------------------|-------------------------------------------------------------|-----------------------|----------------------------------------------|
| F-01       | auth-scaffold              | [RingAbell] Auth scaffold — OAuth + sesje + role systemowe  | nie                   | Zablokowany — weryfikacja nuxt-auth-utils na Workers |
| F-02       | data-scaffold              | [RingAbell] Data scaffold — Mongoose + modele bazowe        | nie                   | Czeka na odblokowanie F-01                   |
| S-01       | admin-user-management      | [RingAbell] Admin — zarządzanie użytkownikami i rolami      | nie                   | Czeka na F-01 + F-02                         |
| S-02       | admin-dictionaries         | [RingAbell] Admin — słowniki ról i wymagań per walka        | nie                   | Czeka na F-01 + F-02                         |
| S-03       | personnel-management       | [RingAbell] Manager — baza personelu (CRUD + dezaktywacja)  | nie                   | Czeka na F-01 + F-02                         |
| S-04       | event-and-fight-management | [RingAbell] Manager — gale, walki, obsada, walidacja live   | nie                   | Czeka na F-01 + F-02 + S-02 + S-03          |
...
1. **Czy nuxt-auth-utils działa poprawnie na Cloudflare Workers (Web Crypto)?** — Owner: dev. Blokuje: F-01, a przez to cały roadmap. Rozwiązanie: smoke-test po instalacji przed pisaniem jakiegokolwiek kodu domenowego.
