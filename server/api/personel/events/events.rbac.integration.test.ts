...
describe('RBAC — GET /api/personel/events', () => {
  ...
  it('returns 200 when session role is Personel', async () => {
  ...
  it('returns 403 when session role is Manager', async () => {
  ...
  it('returns 403 when session role is Admin', async () => {
